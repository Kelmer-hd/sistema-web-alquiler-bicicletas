...
<title>Portal de Alquiler de Bicicletas</title>
<!--Bootstrap -->
      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            ...
            <p>Tenemos más de mil bicicletas para que elijas. </p>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Encuentra la mejor <span>bicicleta para ti</span></h2>
      <p>¡Podrás disfrutar plenamente de tus vacaciones y de tu viaje! ¿Algún problema? ¡Nuestro apasionado equipo e
        stará encantado de ayudarte! ¡No pierda tiempo durante sus vacaciones para encontrar un punto de alquiler en 
        el acto! ¡Sin barrera de idioma, gracias a nuestro equipo multilingüe! ¡Al mismo precio que pagaría en el acto!
        Tenemos las mejores bicicletas con las mejores ofertas.
      </p>
    </div>
    <div class="row">
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">Nuevas Bicicletas</a></li>
        </ul>
      </div>
...
<span class="price">$<?php echo htmlentities($result->PricePerDay);?> /Día</span>
</div>
...
<section class="section-padding testimonial-section parallex-bg">
  <div class="container div_zindex">
    <div class="section-header white-text text-center">
      <h2>Nuestra satisfecha <span>Opinión del cliente</span></h2>
    </div>
    <div class="row">
