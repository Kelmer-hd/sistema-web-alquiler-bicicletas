		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
                  ...
                  <option value="" selected="selected" class="form-control">***Selectar Una***</option>
                  <option value="manage-pages.php?type=terms">Terminos y condiciones</option>
                  <option value="manage-pages.php?type=privacy">privacidad y politica</option>
