			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Imagen del vehículo 3 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Imagen del vehículo 3 Detalles</div>
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Subir nueva imagen 3<span style="color:red">*</span></label>
												<div class="col-sm-8">
