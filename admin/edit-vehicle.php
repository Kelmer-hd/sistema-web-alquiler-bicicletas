...
<head>
	...
	<title>Portal Bike House | Admin</title>
...
<div class="form-group">
<label class="col-sm-2 control-label">Pricio por Día<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="priceperday" class="form-control" value="<?php echo htmlentities($result->PricePerDay);?>" required>
</div>
<label class="col-sm-2 control-label">Seleccionar Tipo<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<label class="col-sm-2 control-label">Asientos<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<label for="inlineCheckbox2"> Cerraduras eléctricas </label>
</div>
<?php } else {?>
...
<label for="inlineCheckbox2">Bolsa de aire del conductor</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Bolsa de aire del pasajero </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Eléctricas </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox1" name="powerwindow" value="1">
<label for="inlineCheckbox3"> Electricas </label>
</div>
<?php } ?>
</div>
...
<label for="inlineCheckbox1"> Reproductor de CD </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2">Cierre centralizado</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-success checkbox-inline">
...
<label for="inlineCheckbox3"> Sensor de colisión </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Asientos de piel </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
