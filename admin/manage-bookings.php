...
if($result->Status==0)
{
echo htmlentities('Aún no confirmado');
...
echo htmlentities('Confirmado');
 	...
 	echo htmlentities('Cancelado');
										...
										<td><a href="manage-bookings.php?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('¿De verdad quieres Confirmar esta reserva?')"> Confirmar</a> /


<a href="manage-bookings.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('¿Realmente desea cancelar esta reserva?')"> Cancelar</a>
</td>
