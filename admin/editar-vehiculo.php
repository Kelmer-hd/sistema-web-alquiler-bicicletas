...
$sql="update tblvehiculos set VehiclesTitle=:vehicletitle,VehiclesBrand=:brand,VehiclesOverview=:vehicleoverview,PricePerDay=:priceperday,FuelType=:fueltype,aYear=:modelyear,SeatingCapacity=:seatingcapacity,AirConditioner=:airconditioner,PowerDoorLocks=:powerdoorlocks,AntiLockBrakingSystem=:antilockbrakingsys,BrakeAssist=:brakeassist,PowerSteering=:powersteering,DriverAirbag=:driverairbag,PassengerAirbag=:passengerairbag,PowerWindows=:powerwindow,CDPlayer=:cdplayer,CentralLocking=:centrallocking,CrashSensor=:crashcensor,LeatherSeats=:leatherseats where id=:id ";
...
<head>
	...
	<title>Portal Bike House | Admin Editar Vehículo</title>
...
<?php if($msg){?><div class="succWrap"><strong>EXITO</strong>:<?php echo htmlentities($msg); ?> </div><?php } ?>
<?php
$id=intval($_GET['id']);
...
<div class="form-group">
<label class="col-sm-2 control-label">Resumen de vehículo<span style="color:red">*</span></label>
<div class="col-sm-10">
...
<!--
	<label class="col-sm-2 control-label">Seleccionar tipo de combustible<span style="color:red">*</span></label>
	<div class="col-sm-4">
...
<div class="form-group">
<div class="col-sm-12">
<h4><b>Imágenes de vehículos</b></h4>
</div>
</div>
...
<div class="form-group">
<div class="col-sm-4">
Imagen 1 <img src="img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage1.php?imgid=<?php echo htmlentities($result->id)?>">Cambiar imagen 1</a>
</div>
<div class="col-sm-4">
Imagen 2<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage2);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage2.php?imgid=<?php echo htmlentities($result->id)?>">Cambiar imagen  2</a>
</div>
<div class="col-sm-4">
Imagen 3<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage3);?>" width="300" height="200" style="border:solid 1px #000">
...
<label for="inlineCheckbox1"> Aire acondicionado </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2"> Cerraduras eléctricas para puertas </label>
</div>
<?php } else {?>
...
<label for="inlineCheckbox3"> Sistema de freno antibloqueo </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Asistente de freno </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox1"> Dirección asistida </label>
</div>
<?php } else {?>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
