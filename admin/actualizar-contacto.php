...
$sql="update tblcontactoinfo set Direccion=:address,EmailId=:email,Contacto=:contactno";
...
<head>
	...
	<title>Portal Bike House | Admin Actualizar Contacto</title>
	...
	<?php include('includes/leftbar.php');?>
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<?php $sql = "SELECT * from  tblcontactoinfo ";
$query = $dbh -> prepare($sql);
$query->execute();
...
{				?>
				...
				<div class="form-group">
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Identificación de correo</label>
												<div class="col-sm-8">
