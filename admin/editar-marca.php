...
$brand=$_POST['brand'];
$id=$_GET['id'];
$sql="update  tblmarcas set NombreMarca=:brand where id=:id";
...
<head>
	...
	<title>Portal Bike House | Admin Crear Marca</title>
...
<?php
$id=$_GET['id'];
$ret="select * from tblmarcas where id=:id";
...
?>
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control" value="<?php echo htmlentities($result->NombreMarca);?>" name="brand" id="brand" required>
												</div>
											</div>
