...
$sql ="SELECT Contrasena FROM admin WHERE Usuario=:username and Contrasena=:password";
...
if($query -> rowCount() > 0)
{
$con="update admin set Contrasena=:newpassword where Usuario=:username";
...
$error="Su contraseña actual no es válida.";
}
}
?>
...
<head>
	...
	<title>Portal Bike House | Admin Cambio contraseña</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Cambiar la contraseña</h2>
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php }
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">campos de formulario</label>
												<div class="col-sm-8">
