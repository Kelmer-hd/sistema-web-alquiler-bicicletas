...
<div class="form-group">
<label class="col-sm-2 control-label">Descripción del Vehiculo<span style="color:red">*</span></label>
<div class="col-sm-10">
...
<label for="antilockbrakingsys"> Sistema de freno antibloqueo </label>
</div></div>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="brakeassist" name="brakeassist" value="1">
<label for="brakeassist"> Asistente de freno </label>
</div>
</div>
...
<input type="checkbox" id="powersteering" name="powersteering" value="1">
<label for="inlineCheckbox5"> Manejo suave </label>
</div>
</div>
...
<label for="centrallocking">Cierre centralizado</label>
</div></div>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
<input type="checkbox" id="crashcensor" name="crashcensor" value="1">
<label for="crashcensor"> Sensor de colisión </label>
</div></div>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
<input type="checkbox" id="leatherseats" name="leatherseats" value="1">
<label for="leatherseats"> Asientos de piel </label>
</div>
</div>
</div>
