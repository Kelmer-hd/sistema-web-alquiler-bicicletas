...
<title>Portal Bike House | Lista de vicicletas</title>
<!--Bootstrap -->
...
$cnt=$query->rowCount();
?>
<p><span><?php echo htmlentities($cnt);?> Listados</span></p>
</div>
</div>
...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <p class="list-price">$<?php echo htmlentities($result->PricePerDay);?> Precio Por Día</p>
            <ul>
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-filter" aria-hidden="true"></i> Encuentra tu bicicleta </h5>
          </div>
		...
		<?php }} ?>
							...
							<div class="form-group select">
								<select class="form-control" name="fueltype">
									<option>Selectionar Tipo de Bicicleta</option>
		...
		<option value="infantiles">Infantiles</option>
							...
							<div class="form-group">
								<button type="submit" class="btn btn-block"><i class="fa fa-search" aria-hidden="true"></i>Buscar Bicicleta</button>
							</div>
						</form>
					</div>
				</div>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-car" aria-hidden="true"></i> Bicicletas listadas recientemente</h5>
          </div>
...
{  ?>
              ...
              <li class="gray-bg">
                ...
                <div class="recent_post_title"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->VehiclesTitle);?></a>
                  <p class="widget_price">$<?php echo htmlentities($result->PricePerDay);?> Precio por Día</p>
                </div>
              </li>
              <?php }} ?>
