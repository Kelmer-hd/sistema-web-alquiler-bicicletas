...
<title>Portal Bike House | Mi Perfil</title>
<!--Bootstrap -->
         ...
         if($msg){?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post">
           <div class="form-group">
            ...
            <div class="form-group">
              <label class="control-label">Última actualización en  -</label>
            ...
            <div class="form-group">
              <label class="control-label">Fecha de naciemiento&nbsp;(dd/mm/yyyy)</label>
