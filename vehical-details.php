...
<title>Portal Bike House | Detalles</title>
<!--Bootstrap -->
    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p>$<?php echo htmlentities($result->PricePerDay);?> </p>Precio por Día
        ...
        <div class="listing_more_info">
          <div class="listing_detail_wrap">
            ...
            <ul class="nav nav-tabs gray-bg" role="tablist">
              <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" data-toggle="tab">Descripción del vehículo </a></li>
...
<tr>
<td>Sistema de frenos antibloqueo</td>
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            <div class="form-group">
              <input type="date" class="form-control" name="fromdate" placeholder="De (dd/mm/yyyy)" required>
            </div>
            <div class="form-group">
              <input type="date" class="form-control" name="todate" placeholder="Hasta (dd/mm/yyyy)" required>
            </div>
            <div class="form-group">
          ...
          <?php if($_SESSION['login'])
              {?>
              <div class="form-group">
                <input type="submit" class="btn"  name="submit" value="Reservar Ahora">
              </div>
              <?php } else { ?>
          ...
          <div class="product-listing-m gray-bg">
            ...
            <div class="product-listing-content">
             ...
             <li><i class="fa fa-user" aria-hidden="true"></i><?php echo htmlentities($result->SeatingCapacity);?> Asientos</li>
                <li><i class="fa fa-calendar" aria-hidden="true"></i><?php echo htmlentities($result->ModelYear);?> Año</li>
