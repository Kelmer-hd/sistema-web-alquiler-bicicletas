...
<li>
                ...
                <div class="vehicle_title">
                  ...
                  <p><b>Desde la fecha:</b> <?php echo htmlentities($result->FromDate);?><br /> <b>Hasta la fecha:</b> <?php echo htmlentities($result->ToDate);?></p>
                </div>
 ...
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Cancelado</a>
            <div class="clearfix"></div>
                ...
                <?php } else { ?>
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Aún no confirmado</a>
            <div class="clearfix"></div>
        </div>
                <?php } ?>
