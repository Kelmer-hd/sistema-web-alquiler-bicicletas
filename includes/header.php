        ...
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <p class="uppercase_text">Envíenos un correo: </p>
              <a href="mailto:info@example.com">bikehouse@gmail.com</a> </div>
            <div class="header_widgets">
              <div class="circle_icon"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
              <p class="uppercase_text">Línea de ayuda: </p>
              <a href="tel:61-1234-5678-09">+51 972054121</a> </div>
            <div class="social-follow">
              <ul>
                <li><a href="https://"><i class="fa fa-facebook-square" aria-hidden="true"></i></a></li>
                <li><a href="https://"><i class="fa fa-twitter-square" aria-hidden="true"></i></a></li>
                <li><a href="https://"><i class="fa fa-linkedin-square" aria-hidden="true"></i></a></li>
                <li><a href="https://"><i class="fa fa-google-plus-square" aria-hidden="true"></i></a></li>
                <li><a href="https://"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
              </ul>
            </div>
   <?php   if(strlen($_SESSION['login'])==0)
	{
?>
 <div class="login_btn"> <a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Inicar Sesión / Registrate</a> </div>
<?php }
else{
	 ...
	 echo htmlentities($result->FullName); }}?><i class="fa fa-angle-down" aria-hidden="true"></i></a>
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <li><a href="bike-listing.php">Bicicletas</a>
