  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
            ...
            <div class="col-md-12 col-sm-6">
              <form  method="post" name="signup" onSubmit="return valid();">
                <div class="form-group">
                  <input type="text" class="form-control" name="fullname" placeholder="Nombre" required="required">
                </div>
                      <div class="form-group">
                  <input type="text" class="form-control" name="mobileno" placeholder="Numero de Telefono" maxlength="10" required="required">
                </div>
                <div class="form-group">
                ...
                <div class="form-group checkbox">
                  ...
                  <label for="terms_agree">Estoy de acuerdo con <a href="#">Términos y condiciones</a></label>
                </div>
                <div class="form-group">
                  <input type="submit" value="Registrarme" name="signup" id="submit" class="btn btn-block">
                </div>
              </form>
            </div>
      ...
      <div class="modal-footer text-center">
        <p>¿Ya tienes una cuenta? <a href="#loginform" data-toggle="modal" data-dismiss="modal">Iniciar Sesión Aqui</a></p>
      </div>
    </div>
  </div>
</div>