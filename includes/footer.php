...
if($lastInsertId)
{
echo "<script>alert('Suscrito con éxito.');</script>";
}
else
{
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <li><a href="page.php?type=terms">Condiciones de uso</a></li>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 col-md-pull-6">
          <p class="copy-right">Copyright &copy; 2023 Portal Bike House.  Realizdo por <a href="https://"></a>Alumnos de la UTP</p>
        </div>
      </div>
    </div>
  </div>
